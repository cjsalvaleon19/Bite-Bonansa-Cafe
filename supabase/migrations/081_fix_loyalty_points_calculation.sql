-- ============================================================================
-- Fix Loyalty Points Calculation
-- Remove the minimum 1.00 enforcement. Points should be > 0 naturally from
-- the percentage calculation (0.2% or 0.35%), not forced to a minimum.
-- Example: ₱84 subtotal = 0.17 points (84 * 0.002 = 0.168 → 0.17)
-- ============================================================================
