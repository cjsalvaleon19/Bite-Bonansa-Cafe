# Fix for EOD Report and POS Errors
...
3. **Missing DOM Element**: `Could not find element with selector .header-and-quick-actions-mfe-Header--organisation-name-text`
...
### 3. Missing DOM Element (Frontend Issue)
...
These migrations and code changes resolve the critical errors in the EOD Report and POS system by:
...
3. Updating the application code to properly save variant details
